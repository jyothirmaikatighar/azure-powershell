...
### -SamplingMode
Turns sampling for distributed tracing enable and disable.
...
### -SamplingRate
Controls the amount of messages sampled for adding trace context.
This value is a percentage.
Only values from 0 to 100 (inclusive) are permitted.
